...
transaction1 = Transaction.new({"amount" => 25, "merchant_id" => merchant1.id, "category_id" => category1.id})
transaction2 = Transaction.new({"amount" => 60, "merchant_id" => merchant2.id, "category_id" => category2.id})
transaction3 = Transaction.new({"amount" => 32, "merchant_id" => merchant3.id, "category_id" => category3.id})
transaction4 = Transaction.new({"amount" => 124, "merchant_id" => merchant4.id, "category_id" => category4.id})
